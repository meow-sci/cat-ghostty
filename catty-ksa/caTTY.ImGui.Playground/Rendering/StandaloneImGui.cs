...
{
    private static GlfwWindow window = default!;
    private static Renderer renderer = default!;
    private static RenderPassState rstate = default!;
    private static Action OnDrawUi = default!;

    /// <summary>
    /// Runs the ImGui application with the specified draw callback.
    /// </summary>
    ...
    private static void Init()
    {
        ...
        {
            Title = "caTTY Terminal Rendering Experiments",
