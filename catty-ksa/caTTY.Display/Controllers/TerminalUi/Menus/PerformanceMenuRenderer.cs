...
/// <summary>
/// Handles rendering of the Performance menu with tracing controls.
...
/// </summary>
internal class PerformanceMenuRenderer
{
  private readonly PerformanceStopwatch _perfWatch;

  public PerformanceMenuRenderer(PerformanceStopwatch perfWatch)
  {
