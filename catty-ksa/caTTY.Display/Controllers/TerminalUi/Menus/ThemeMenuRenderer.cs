...
/// <summary>
/// Handles rendering of the Theme menu with theme selection and customization options.
/// Provides access to built-in and TOML-loaded themes with refresh capability.
/// </summary>
internal class ThemeMenuRenderer
{
  private readonly ThemeConfiguration _themeConfig;

  public ThemeMenuRenderer(ThemeConfiguration themeConfig)
  {
