        ...
        if (Directory.Exists(fontsDir))
        {
          ...
          if (fontFiles.Length > 0)
          {
            ...
            for (int i = 0; i < fontFiles.Length; i++)
            {
              ...
              Console.WriteLine($"caTTY GameMod: Loading font: {fontPath}");
              ...
              if (File.Exists(fontPath))
              {
                ...
                float fontDensity = (float)GameSettings.GetFontDensity() / 100f;
            ...
            Console.WriteLine($"caTTY GameMod: Loaded {LoadedFonts.Count} fonts - {string.Join(", ", LoadedFonts.Keys)}");
          }
          else
          {
