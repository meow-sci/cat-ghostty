...
**The terminal is working correctly for its current implementation stage.** The mixing of readable text with literal escape sequences is expected behavior until escape sequence parsing is implemented in Section 2.
