...
/// <summary>
/// Registry for managing game action command registration and lifecycle.
...
public class GameActionRegistry : IGameActionRegistry
{
    ...
    /// <summary>
    /// Initializes a new instance of the GameActionRegistry.
    /// </summary>
    ...
    public void RegisterVehicleCommands()
    {
        ...
        _logger.LogInformation("Registered {Count} default vehicle control commands", GetRegisteredCommands().Count());
    }
    ...
    private void RegisterValidationRules()
    {
        ...
        _logger.LogDebug("Registering parameter validation rules for vehicle commands");
        ...
        _logger.LogDebug("Registered parameter validation rules for {Count} vehicle commands", 3);
    }
}
...
/// Command ID: 1001
/// </summary>
internal class IgniteMainThrottleCommand : FireAndForgetCommandHandler
{
...
/// Command ID: 1002
/// </summary>
internal class ShutdownMainEngineCommand : FireAndForgetCommandHandler
{
...
/// Command ID: 2001
/// </summary>
internal class GetThrottleStatusQuery : QueryCommandHandler
{
