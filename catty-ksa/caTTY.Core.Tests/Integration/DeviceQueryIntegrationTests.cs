...
public class DeviceQueryIntegrationTests
{
    ...
    public void SetUp()
    {
        ...
        {
            var responseText = Encoding.UTF8.GetString(args.ResponseData.Span);
    ...
    public void DeviceQueries_WithMixedContent_ShouldRespondCorrectly()
    {
        ...
        Assert.That(_responses[1], Is.EqualTo("\x1b[5;25R"));  // CPR response (cursor at row 5, col 25 after "Test" + " more text ")
    ...
    public void DeviceQueries_WithCursorMovement_ShouldReportCorrectPosition()
    {
        ...
        foreach (var (moveCommand, expectedResponse) in positions)
        {
            _responses.Clear();
