...
internal static class Native
{
  ...
  private const string DLL_NAME =
      "/Users/asherwin/repos/meow-sci/cat-ghostty/dotnet-exe-link-libghostty/lib/libghostty-vt.0.1.0.dylib";
  ...
  public static int Main2(string[] args)
  {
    ...
    catch (DllNotFoundException e)
    {
      Console.Error.WriteLine(
          "Native library not found. Make sure lib/ghostty-vt.dll is copied to the output folder. Error: " +
          e.Message);
      return 1;
    }
  }
